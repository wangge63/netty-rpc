...
public class SystemConfig {
    ...
    public static final Duration SERIALIZE_POOL_MAX_WAIT_MILLIS = Duration.ofSeconds(3);
    public static final Duration SERIALIZE_POOL_MIN_EVICTABLE_IDLE_TIME_MILLIS = Duration.ofSeconds(60);
